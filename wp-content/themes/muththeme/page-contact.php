...
<section class="muth-map">
  <div class="muth-map-content">
    <div class="row">
      ...
      <h2><?php if(get_field('title_map')): the_field('title_map'); endif; ?></h2>
      ...
      //check if the repeater field has rows of data
       ...
       //loop through the rows of data
           while ( have_rows('addresses') ) : the_row();
            echo $glyphicon_counter;

            if ($glyphicon_counter%2):
              $glyphicon_class = 'k'; //korespondencna
            else:
              $glyphicon_class = 'n'; //normalna
            endif;

            echo $glyphicon_class;
