  ...
  <div class="slider-content">
    <div class="row">
          ...
          <div class="muth-banner-image">
            <img data-wow-delay=".2s" class="animated fadeInUp wow" src="http://www.muth.sk/wp-content/uploads/2016/08/monitor.png" alt="muth-display">
            <img data-wow-delay=".3s" data-wow-duration="2s" class="muth-banner-notebook animated bounceInLeft wow" src="http://www.muth.sk/wp-content/uploads/2016/08/notebook.png" alt="muth-notebook">
            <img data-wow-delay=".3s" data-wow-duration="2s" class="muth-banner-mobile-group animated bounceInRight wow" src="http://www.muth.sk/wp-content/uploads/2016/08/mobile-group.png" alt="muth-mobile-group">
            <img class="muth-mobile-slider" src="http://www.muth.sk/wp-content/uploads/2016/08/mobile.png" alt="muth-mobile">
          </div>
      </div>
  </div>
    </section> <!-- slider -->
